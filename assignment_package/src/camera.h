...
public:
    ...
    float phi;   // Angle representing the rotation around the X-axis
    float theta; // Angle representing the rotation around the Y-axis
    float zoom;  // Translation along the Z-axis
